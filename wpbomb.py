...
# well, i'm not the real owner of this script i just take it from unknown source and just updated it

# ------------------------------------------------------------------------------------------------
# AUTHOR: GUCCIFER SHUBHAM      | WE'RE ANONYMOUS               | FUCK THE CORPORATE SYSTEM AND  #
# WHATSAPP: +91 9485875345      | WE DON'T FORGET ANYTHINGS     | ROB THE RICH AND               #
# FACEBOOK: SHUBHUSHUBHU99      | WE DON'T FORGIVE ANYONES      | FEED THE POOR                  #
# GITHUB: SHUBHUSHUBHU99        | EXPECT US...                  | EXPECT US...                   #
# ------------------------------------------------------------------------------------------------
...
%s╲┃┈┈┈┈┈┈┃%s╲╲╲╲╲╲╲%s╚╩╝╩ ╩╩ ╩ ╩ ╚═╝╩ ╩╩  ╩  
%s AUTHOR:UNKNOWN 
%s UPDATED BY GUCCIFER SHUBHAM
%s WHATSAPP: +91 9485875345
